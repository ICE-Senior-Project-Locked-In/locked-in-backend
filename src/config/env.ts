...
const envSchema = z.object({
    ...
    REFRESH_TOKEN_COOKIE_SAME_SITE: z.enum(["lax", "strict", "none"]).default("strict"),
...
export const config = {
  ...
  refreshTokenCookieSameSite: env.REFRESH_TOKEN_COOKIE_SAME_SITE,
  refreshTokenCookieDomain: env.REFRESH_TOKEN_COOKIE_DOMAIN,
